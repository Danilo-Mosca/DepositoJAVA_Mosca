...
import com.example.libreria.exceptions.*;
...
public class GlobalExceptionHandler {
    ...
    // Gestisce l'eccezione della data di pubblicazione verificando che il valore inserito sia un intero, altrimenti lancio l'eccezione
    ...
    //Eccezione che si verifica con l'inserimento di una data di pubblicazione (yearOfPublication) come stringa e non numerica
    ...
    //Eccezione che gestisce UserNotFoundException quando l'id per quell'utente non viene trovato nella tabella User
    ...
    // Eccezione che gestisce UserNameNotFoundException quando non viene trovato il nome per quell'utente nella tabella User
    ...
    // Eccezione che gestisce UserNotFoundException quando non viene trovato il cognome per quell'utente nella tabella User
    ...
    // Eccezione che gestisce UserNotFoundException quando non viene trovato il nome + cognome per quell'utente nella tabella User
    ...
    // Eccezione che gestisce BookUnavailableException ovvero un utente ricerca un libro e questo non è disponibile per il prestito (cioè quanto available = false)
    ...
    // Eccezione che gestisce BookNotPrenotedException ovvero quando un utente ricerca un libro che è disponibile e non risulta prenotato (cioè quanto available = true)
