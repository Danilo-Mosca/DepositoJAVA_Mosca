...
3) Classe Studente (extends Persona, implements Registrabile) Ogni Studente deve avere poi due figli specifici
...
4) Classe Docente (extends Persona, implements Registrabile)  Ogni docente deve avere poi due figli specifici
...
Requisiti Obbligatori:
    ...
    - Ogni studente sarà assegnato a un docente in una lista di studentiSpecificiX e solo il il docenteSpecificoX potrà avere
