...
public class Esercizio3Funzioni {
    public static void main(String[] args) {
        ...
        System.out.println("Somma dei primi " + sommaNumeriConRircorsione + " numeri naturali: " + ricorsione);
        ...
        inputNumbers.close(); // Chiudo lo Scanner "inputNumbers" e libero le risorse
    }
